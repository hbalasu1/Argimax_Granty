...
// module for Graph
var appG = express();
var serverG = require('http').Server(appG);
var io = require('socket.io').listen(serverG);
serverG.listen(3000,function(){
 console.log('Graph Server Running @ Port 3000');
});

appG.use(express.static(__dirname + '/'));
...
console.log(temp.name()); //check if upm is work
...
///***** NOT SURE WILL CONFLIG OR NOT
appG.get('/', function (req, res) {
  res.sendfile(__dirname + '/../client/index.html');
  console.log(__dirname + '/../client/index.html')
});


// Emit Sensor Data and current date
